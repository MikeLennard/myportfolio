        ...
        <div className="pt-4 border-t border-[#2B5748] flex items-center justify-end gap-3">
          ...
          {github && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-4 py-2 text-xs font-semibold text-[#f1f5f0] bg-[#273338] hover:bg-[#2B5748] border border-[#2B5748] rounded-xl transition-colors flex items-center gap-1.5"
            >
