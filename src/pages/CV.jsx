      ...
      <div className="no-print max-w-4xl mx-auto mb-6">
        <div className="glass-panel p-4 rounded-2xl flex items-center justify-between gap-4 border border-[#9CB080]/30 shadow-xl">
          ...
          <div className="flex items-center gap-2.5">
            {/* Direct PDF download for phones & mobile browsers */}
            <a
              href="/Mike_Lennard_Dela_Cruz_CV.pdf"
              download="Mike_Lennard_Dela_Cruz_CV.pdf"
            ...
            {/* Desktop Print-to-PDF button */}
            <button
              onClick={handlePrint}
              type="button"
              className="hidden sm:flex px-3.5 py-2 rounded-xl bg-[#273338] hover:bg-[#2B5748] text-[#CBD5C0] hover:text-white text-xs font-semibold border border-[#2B5748] items-center gap-1.5 cursor-pointer transition-all"
            >
